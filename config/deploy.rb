...
set :application, 'project_store'
set :repo_url, 'git@github.com:sasha370/project_store.git'
...
set :deploy_to, "/home/deploy/project_store"
...
"vendor", "storage", '.bundle', 'public/system', 'public/uploads'
#
